# -*- coding: utf-8 -*-
"""
Created on Thu Apr 13 08:31:10 2017
...
class NeuralNetMLP(object):
    ...
    #additional code for gradient checking
...
#initialisation of NN with 50 hidden units and 10 output units
nn = NeuralNetMLP(n_output=10, n_features=X_train.shape[1], n_hidden=100, l2=0.1, l1=0.0, epochs=1000, eta=0.001, alpha=0.001, decrease_const=0.00001, shuffle=True, minibatches=50, random_state=1)
    
nn.fit(X_train, y_train, print_progress=True) 

nn2 = NeuralNetMLP(n_output=10, n_features=X_train.shape[1], n_hidden=400, l2=0.1, l1=0.0, epochs=1000, eta=0.0005, alpha=0.0005, decrease_const=0.00001, shuffle=True, minibatches=100, random_state=1)
nn2.fit(X_train, y_train, print_progress=True) 



    
#drawing diagram showing how and when convergence is reached
...
result.to_csv('NN result.csv', index=False, header=True)
